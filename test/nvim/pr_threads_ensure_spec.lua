...
describe("pr.threads.marker_mode", function()
    ...
    it("markers in split whatever comments.inline says", function()
        require("differ").setup({ comments = { inline = true } })
    ...
    it("markers in stacked when comments.inline is off", function()
        require("differ").setup({ comments = { inline = false } })
